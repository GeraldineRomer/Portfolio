...
const BlobHome = () => {
    ...
    const blobSize = 200; // Tamaño del blob
    const imageSize = 100; // Tamaño de la imagen
    const imageRotation = 180; // Ángulo de rotación de la imagen
    const imageX = blobSize / 2 - imageSize / 2; // Coordenada x para centrar la imagen
    const imageY = blobSize / 2 - imageSize / 2; // Coordenada y para centrar la imagen
        ...
        <div>
            ...
            <g transform={`translate(153, 141) rotate(${imageRotation})`}>
